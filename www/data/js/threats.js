...
let path = "img/Rainforest Rescue/Goodbye/Threats/"; 
let path2 = "audio/Rainforest Rescue/Goodbye/Threats/"; 
var vocabulary = [3];
let wordsArray = ["Urbanization", "Deforestation", "Irresponsible tourism", "Road construction", "Hunting", "Pollution", "Wildfire"];
let imgArray = [];
let speechArray = [];
