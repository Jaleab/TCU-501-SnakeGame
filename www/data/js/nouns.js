...
let path = "img/Rainforest Rescue/A treasure/Nouns/"; 
let path2 = "audio/Rainforest Rescue/A treasure/Nouns/"; 
var vocabulary = [3];
let wordsArray = ["Rainfall", "Climate", "Canopy", "Fauna", "Flora", "Zipline"];
let imgArray = [];
let speechArray = [];
