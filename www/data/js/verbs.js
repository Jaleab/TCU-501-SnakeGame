...
let path = "img/Connecting Electronically/Taking care of devices/Verbs/"; 
let path2 = "audio/Connecting Electronically/Taking care of devices/Verbs/"; 
var vocabulary = [3];
let wordsArray = ["Charge the battery", "Click on", "Receive a call", "Turn off", "Turn on"];
let imgArray = [];
let speechArray = [];
