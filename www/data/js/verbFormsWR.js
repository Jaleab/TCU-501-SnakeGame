...
let path = "img/Rainforest Rescue/Ways to Rescue it/Verb forms/"; 
let path2 = "audio/Rainforest Rescue/Ways to Rescue it/Verb forms/"; 
var vocabulary = [3];
let wordsArray = ["Protect", "Value", "Educate", "Plant", "Save"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "verbFormsWR.html";
    }
