...
let path = "img/Rainforest Rescue/Ways to Rescue it/Adjectives/"; 
let path2 = "audio/Rainforest Rescue/Ways to Rescue it/Adjectives/"; 
var vocabulary = [3];
let wordsArray = ["Endangered", "Sustainable", "Less"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "adjectivesWR.html";
    }
