...
let path = "img/Rainforest Rescue/Goodbye/Verb forms/"; 
let path2 = "audio/Rainforest Rescue/Goodbye/Verb forms/"; 
var vocabulary = [3];
let wordsArray = ["Cut down", "Damage", "Destroy", "Build"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "verbFormsRR.html";
    }
