...
let path = "img/Weather Wise/Weather and Seasons/Weather conditions/"; 
let path2 = "audio/Weather Wise/Weather and Seasons/Weather conditions/"; 
var vocabulary = [3];
let wordsArray = ["Cloudy","Rainy","Snowy","Sunny","Windy"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "weatherConditions.html";
    }
