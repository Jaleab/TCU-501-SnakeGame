...
let path = "img/Weather Wise/Activities/Indoor Activities/"; 
let path2 = "audio/Weather Wise/Activities/Indoor Activities/"; 
var vocabulary = [3];
let wordsArray = ["Playing board games", "Playing cards", "Playing video games", "Watching TV"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "indoorActivities.html";
    }
