...
let path = "img/Weather Wise/Weather and Seasons/Seasons of the year/"; 
let path2 = "audio/Weather Wise/Weather and Seasons/Seasons of the year/"; 
var vocabulary = [3];
let wordsArray = ["Spring","Autumn","Fall","Winter","Summer"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "seasonsOfTheYear.html";
    }
