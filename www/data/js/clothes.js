...
let path = "img/Weather Wise/What to Wear/Clothes/"; 
let path2 = "audio/Weather Wise/What to Wear/Clothes/"; 
var vocabulary = [3];
let wordsArray = ["Dress", "Pants", "Raincoat", "Shorts", "Skirt", "Sweater", "T-shirt"];
let imgArray = [];
let speechArray = [];
