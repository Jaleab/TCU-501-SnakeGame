...
let path = "img/Weather Wise/Weather and Seasons/Countries/"; 
let path2 = "audio/Weather Wise/Weather and Seasons/Countries/"; 
var vocabulary = [3];
let wordsArray = ["England", "Mexico", "United States", "Russia", "France", "Costa Rica","Nicaragua", "Colombia"];
let imgArray = [];
let speechArray = [];
