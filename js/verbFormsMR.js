...
let path = "img/Rainforest Rescue/My role/Verb forms/"; 
let path2 = "audio/Rainforest Rescue/My role/Verb forms/"; 
var vocabulary = [3];
let wordsArray = ["Make a plan", "Reduce", "Reuse", "Recycle", "Save", "Tell", "Donate", "Learn"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "verbFormsMR.html";
    }
