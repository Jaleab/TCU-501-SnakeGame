...
let path = "img/Rainforest Rescue/My role/Nouns/"; 
let path2 = "audio/Rainforest Rescue/My role/Nouns/"; 
var vocabulary = [3];
let wordsArray = ["Class projects", "Community projects", "Species", "Money", "Time"];
let imgArray = [];
let speechArray = [];
