...
let path = "img/Rainforest Rescue/A treasure/Climate/"; 
let path2 = "audio/Rainforest Rescue/A treasure/Climate/"; 
var vocabulary = [3];
let wordsArray = ["Humid", "Cloudy", "Rainy", "Tropical", "Dry"];
let imgArray = [];
let speechArray = [];
