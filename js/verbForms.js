...
let path = "img/Weather Wise/My Feelings/Verb forms/"; 
let path2 = "audio/Weather Wise/My Feelings/Verb forms/"; 
var vocabulary = [3];
let wordsArray = ["I feel happy", "I go to the school", "I play soccer", "I visit my grandfather", "I wear sunglasses"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "verbForms.html";
    }
