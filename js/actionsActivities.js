...
let path = "img/Connecting Electronically/Using devices/Actions Activities/"; 
let path2 = "audio/Connecting Electronically/Using devices/Actions Activities/"; 
var vocabulary = [3];
let wordsArray = ["Listen to music" ,"Send an email", "Watching videos", "Chatting", "Texting", "Playing games"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "actionsActivities.html";
    }
