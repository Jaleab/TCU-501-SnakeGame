...
let path = "img/Connecting Electronically/Using devices/Electronic devices/"; 
let path2 = "audio/Connecting Electronically/Using devices/Electronic devices/"; 
var vocabulary = [3];
let wordsArray = ["Laptop", "Smartphone", "Mp3", "Wii"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "electronicDevicesUD.html";
    }
