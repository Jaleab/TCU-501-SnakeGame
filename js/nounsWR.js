...
let path = "img/Rainforest Rescue/Ways to Rescue it/Nouns/"; 
let path2 = "audio/Rainforest Rescue/Ways to Rescue it/Nouns/"; 
var vocabulary = [3];
let wordsArray = ["Biodiversity", "Landscape", "Wildlife", "Paper"];
let imgArray = [];
let speechArray = [];
