...
let path = "img/Connecting Electronically/Tablet or computer/Electronic devices/"; 
let path2 = "audio/Connecting Electronically/Tablet or computer/Electronic devices/"; 
var vocabulary = [3];
let wordsArray = ["Cellphones", "Tablet", "Desktop computer", "Smart watch", "Robot"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "electronicDevices.html";
    }
