...
let path = "img/Rainforest Rescue/A treasure/Adjectives/"; 
let path2 = "audio/Rainforest Rescue/A treasure/Adjectives/"; 
var vocabulary = [3];
let wordsArray = ["Warm", "Dense", "Exotic", "Tropical", "Dark"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "adjectives.html";
    }
