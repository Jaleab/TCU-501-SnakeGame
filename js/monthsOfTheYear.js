...
foodImg = new Image();
foodImg.src = "img/Weather Wise/Weather and Seasons/Months of the year/Month.png";
let path = "img/Weather Wise/Weather and Seasons/Months of the year/"; 
let path2 = "audio/Weather Wise/Weather and Seasons/Months of the year/"; 
var vocabulary = [3];
let wordsArray = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(score < vocabulary[0].length){
        ...
        ctx.drawImage(foodImg,170,5,62,62);
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "monthsOfTheYear.html";
    }
