...
let path = "img/Connecting Electronically/Taking care of devices/Parts of smartphone/"; 
let path2 = "audio/Connecting Electronically/Taking care of devices/Parts of smartphone/"; 
var vocabulary = [3];
let wordsArray = ["Battery", "Key pad", "Keyboard", "Power supply", "Screen", "SIM Card"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "partsOfSmartphone.html";
    }
