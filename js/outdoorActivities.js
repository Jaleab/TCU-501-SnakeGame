...
let path = "img/Weather Wise/Activities/Outdoor Activities/"; 
let path2 = "audio/Weather Wise/Activities/Outdoor Activities/"; 
var vocabulary = [3];
let wordsArray = ["Fishing", "Kayaking", "Playing soccer", "Running", "Skateboarding"];
let imgArray = [];
let speechArray = [];
...
function draw(){
    ...
    if(collision(newHead,this.snake)){
        clearInterval(game);
        dead.play();
        window.location = "outdoorActivities.html";
    }
